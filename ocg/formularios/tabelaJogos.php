...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" src="../js/tabelaJogos.js"></script>       
    </head>
...
<!-- <input type="button" class="pull-right Voltar" style='margin-left:0%' onclick="history.go(-1);" href="gerarTabela.php" /> -->
            <div id='titulo'>
                <h2>
                    ...
                    <br>
                    <br>
                    <a class="Voltar esconde" href="gerarTabela.php"></a>
                </h2>
                <br /><br />
            ...
            <div id="chave" style="width:auto;margin-bottom: 3%;">                
                <input type="hidden" id="txtQtdRodada" value="<?= $qtdRodadas ?>" />
                <?php
                /*
            ...
            <div id='resultados' style='width:500px'>
                <table width='600'>
                    ...
                    <span style='font-size:24px'>Resultados: 
                        <input type="button" class='Imprimir esconde' style='margin-left:26.32%'onclick='window.print();' value='Imprimir' />
                        <br />
                        <?php
                        echo $resultados;
                        ?>
