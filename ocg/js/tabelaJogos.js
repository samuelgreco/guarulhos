...
function sorteio(participantes, idProva, potenciaMin) {
    ...
    if (varXML != null) {
        //alert("rodada1: "+rodada1+"     playin: "+playin+"     potenciaMin: "+potenciaMin+"     participantes: "+participantes);
        ...
        if (participantes == 10) {
            ...
            for (var count = 3; count <= 8; count++) {
                $("#lblRodada2Time" + count).html(times[(count + 2)]);
            }
        ...
        if (participantes == 12) {
            ...
            for (var count = 5; count <= 8; count++) {
                $("#lblRodada2Time" + count).html(times[(count + 4)]);
            }

            $("#lblRodada2Time" + 8).html(times[12]);
            return;
        }
        if (participantes == 14) {

            $("#lblRodada2Time" + 7).html(times[13]);
            $("#lblRodada2Time" + 8).html(times[14]);

            return;
        }
        /*============== participantes==17 CORRIGIDO =============*/
        if (participantes == 17) {
            // 
            for (var count = 2; count <= 16; count++) {
                $("#lblRodada2Time" + count).html(times[(count + 1)]);
            }
        ...
        if (participantes == 18) {
            for (var count = 3; count <= 16; count++) {
                $("#lblRodada2Time" + count).html(times[(count + 2)]);
            }
        ...
        if (participantes == 20) {
            ...
            for (var count = 5; count <= 16; count++) {
                $("#lblRodada2Time" + count).html(times[(count + 4)]);
            }
        ...
        if (participantes == 22) {
            ...
            for (var count = 7; count <= 16; count++) {
                $("#lblRodada2Time" + count).html(times[(count + 6)]);
            }
        ...
        if (participantes == 24) {
            ...
            for (var count = 9; count <= 16; count++) {
                $("#lblRodada2Time" + count).html(times[(count + 8)]);
            }

            return;
        }
        /*=================== participantes==26  CORRIGIDO=====================*/
        if (participantes == 26) {
             
            for (var count = 11; count <= 16; count++) {
                $("#lblRodada2Time" + count).html(times[(count + 10)]);
            }
        ...
        if (participantes == 28) {
            ...
            for (var count = 13; count <= 16; count++) {
                $("#lblRodada2Time" + count).html(times[(count + 12)]);
            }
        ...
        if (participantes == 30) {
            ...
            $("#lblRodada2Time" + 15).html(times[29]);
            $("#lblRodada2Time" + 16).html(times[30]);
            return;
        }
        /*=============participantes==33 CORIGIDO===============================*/
        if (participantes == 33) {

            for (var count = 2; count <= 32; count++) {
                $("#lblRodada2Time" + count).html(times[(count + 1)]);
            }
        ...
        if (participantes == 36) {
            ...
            for (var count = 5; count <= 32; count++) {
                $("#lblRodada2Time" + count).html(times[(count + 4)]);
            }
        ...
        if (participantes == 38) {
            for (var count = 7; count <= 32; count++) {
                $("#lblRodada2Time" + count).html(times[(count + 6)]);
            }
        ...
        if (participantes == 40) {
            // 
            for (var count = 9; count <= 32; count++) {
                $("#lblRodada2Time" + count).html(times[(count + 8)]);
            }
        ...
        if (participantes == 42) {
        	//alert(times);
        	for (var count = 11; count <= 32; count++) {
        		$("#lblRodada2Time" + count).html(times[(count + 10)]);
        	}
        ...
        if (participantes == 46) {
        	alert(times);
        	for (var count = 15; count <= 32; count++) {
        		$("#lblRodada2Time" + count).html(times[(count + 14)]);
        	}
        ...
        if (participantes % 2 !== 0 && participantes != 1 || participantes == 6) {
            //Preenche os participantes at� completar a rodada 2 (Demais participantes)


            if (participantes == 39) {
                // 
                for (var count = 8; count <= 32; count++) {
                    $("#lblRodada2Time" + count).html(times[(count + 7)]);
                }
                return;
            }
            if (participantes == 43) {
            	//alert(times);
            	for (var count = 12; count <= 32; count++) {
            		$("#lblRodada2Time" + count).html(times[(count + 11)]);
            	}
            	return;
            }

            var opa = (parseFloat(participantes) + 1) / 2;
            var int = ((Math.pow(2, potenciaMin) - rodada1) + 1);
            for (int; int <= (times.length); int++) {
                //alert("int dentro for: " + int)
                if (opa % 2 != 0 && opa % 3 != 0 && opa % 5 != 0) {

                    if (participantes == 13) {
                        // 
                        for (var count = 6; count <= 8; count++) {
                            $("#lblRodada2Time" + count).html(times[(count + 5)]);
                        }
                        return;
                    }
                    ...
                    if (participantes == 21) {
                        for (var count = 6; count <= 16; count++) {
                            $("#lblRodada2Time" + count).html(times[(count + 5)]);
                        }
                    ...
                    if (participantes == 25) {
                        for (var count = 1; count <= 18; count++) {
                            $("#lblRodada1Time" + count).html(times[(count)]);
                        }

                        for (var count = 10; count <= 16; count++) {
                            $("#lblRodada2Time" + count).html(times[(count + 9)]);
                        }
                    ...
                    if (participantes == 33) {
                        $("#lblRodada1Time" + 1).html(times[1]);
                        $("#lblRodada1Time" + 2).html(times[2]);

                        for (var count = 2; count <= 32; count++) {
                            $("#lblRodada2Time" + count).html(times[(count++)]);
                        }
                    ...
                    if (participantes == 35) {
                        ...
                        for (var count = 4; count <= 32; count++) {
                            $("#lblRodada2Time" + count).html(times[(count + 3)]);
                        }
                        return;
                    }
                    ...
                    if (participantes == 41) {
                    	...
                    	for (var count = 10; count <= 32; count++) {
                            $("#lblRodada2Time" + count).html(times[(count + 9)]);
                        }
                    	return;
                    }
                    ...
                    if (participantes == 45) {
                    	alert(times);
                    	for (var count = 14; count <= 32; count++) {
                    		$("#lblRodada2Time" + count).html(times[(count + 13)]);
                    	}
                    	return;
                    }
                    ...
                    $("#lblRodada2Time" + Math.floor(opa)).html(times[participantes]);
                    $("#lblRodada2Time" + Math.floor(opa++)).html(times[participantes]);
                    if (participantes == 6) {
                        $("#lblRodada2Time" + 4).html(times[5]);
                    }
                    (times[participante]);
                }


                $("#lblRodada2Time" + opa++).html(times[participantes]);

                if (participantes == 5 && opa != 6) {
                    var carregar = (participantes - 1) / 2;
                    //$("#lblRodada2Time" + opa).html(times[participantes]);
                    $("#lblRodada2Time" + opa).html(times[--participantes]);
                    $("#lblRodada2Time" + opa).html(times[participantes++]);
                    $("#lblRodada2Time" + (opa++) / 2).html(times[participantes - 2]);
                }
                ...
                if (participantes == 19) {
                    for (var count = 4; count <= 16; count++) {
                        $("#lblRodada2Time" + count).html(times[(count + 3)]);
                    }
                ...
                if (participantes == 29) {
                    ...
                    $("#lblRodada2Time" + 14).html(times[27]);
                    $("#lblRodada2Time" + 15).html(times[28]);
                    $("#lblRodada2Time" + 16).html(times[29]);
                    return;
                }
