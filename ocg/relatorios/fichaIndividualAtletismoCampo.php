<?php
session_start();
$class = new fichaIndividualAtletismoCampo();
?>
        ...
        foreach ($class->lst as $k => $v) {
            ...
            <table border=5 bordercolor=black width=600>
                ...
                <tr>
                    <td>
                        <center>
                            <?= utf8_encode($v['DESC_CATEGORIA']) ?> <br /> <?= $v['SEXO'] ?>
                        </center>
                    </td>
                ...
                <tr>
                    <td colspan=4 width=150>Resultados:
                    </td>
                    <tr height=50>
                        <td width=150>
                            &nbsp;
                    ...
                    <tr height=50 >
                        <td colspan=2 >Final:<br />.
                        </td>
                        <td colspan=2 >Classifica&ccedil;&atilde;o:<br />.
                        </td>
                    </tr>
            </table>
...
class fichaIndividualAtletismoCampo {
