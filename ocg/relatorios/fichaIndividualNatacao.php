<?php
session_start();
$class = new fichaIndividualNatacao();
?>
        ...
        foreach ($class->lst as $k => $v) {
            ...
            <table border=5 bordercolor=black width=600>
                <tr height=50 >
                    <td width=150>
                        <center>
                            <img src='../imagem/OCG.png' width=80 />
                        </center>
                    </td>
                    <td colspan=3>
                        <center>
                ...
                <tr>
                    ...
                    <td colspan=3 >Prova: <br> <?= utf8_encode($v['DESCPROVA']) ?>
                    </td>
                </tr>
                <tr>
                    <td colspan=3 >
                        Nome: <?= utf8_encode($v['NOME_ALUNO']) ?>
                    </td>
                    <td>
                        <?= utf8_encode($v['DESC_CATEGORIA']) ?> / <?= $v['SEXO'] ?>
                    </td>                    
                </tr>
                <tr>
                    <td colspan=4 >
                        Escola: <?= utf8_encode($v['NOME_ESCOLA']) ?> 
                    </td>
                </tr>
                <tr height=50 >
                    <td colspan=2 >Tempo:<br>.</td>
                    <td colspan=2 >Resultado:<br>.</td>
                </tr>
            </table>
            ----------------------------------------------------------------------------------------------------
            <?php
